...
def get_conf_themes(conf_id=None, host=DEFAULT_HOST, port=DEFAULT_PORT):
    connection = connection_to_redis(host=host, port=port)
...
@decorator_connection
def set_themes_for_conf(conf_id=None, conf_themes=None, connection=None, host=DEFAULT_HOST, port=DEFAULT_PORT):
    connection = connection_to_redis(host=host, port=port)
...
def add_new_theme(theme = None, host=DEFAULT_HOST, port=DEFAULT_PORT):
    connection = connection_to_redis(host=host, port=port)
...
def del_theme(theme = None,host=DEFAULT_HOST, port=DEFAULT_PORT):
    connection = connection_to_redis(host=host, port=port)
